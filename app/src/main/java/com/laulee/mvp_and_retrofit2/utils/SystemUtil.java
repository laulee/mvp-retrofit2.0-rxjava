...
import com.laulee.mvp_and_retrofit2.app.App;
import com.laulee.mvp_and_retrofit2.app.Constants;
...
public class SystemUtil {
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) App.getInstance().getApplicationContext().getSystemService(
